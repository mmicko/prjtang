...
std::string get_database_path()
{
    ...
    boost::filesystem::path database_datadir_relative(TANG_RPATH_DATADIR "/" TANG_PROGRAM_PREFIX "tang/database");
...
std::string get_database_path()
{
    ...
    boost::filesystem::path database_datadir_relative(TANG_RPATH_DATADIR "/tang/database");
    std::string database_folder = (executable_path /= database_datadir_relative).string();
    return database_folder;
}
