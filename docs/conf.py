...
if not on_rtd:
    html_context = {
        ...
        "github_user": "mmicko",  # Username
        "github_repo": "prjtang",  # Repo name
...
latex_documents = [
    (
        master_doc, 'ProjectTang.tex', u'Project Tang Documentation',
...
man_pages = [
    (master_doc, 'projecttang', u'Project Tang Documentation', [author], 1)
]
...
texinfo_documents = [
    (
        master_doc, 'ProjectTang', u'Project Tang Documentation', author,
        'ProjectTang', 'One line description of project.', 'Miscellaneous'),
]
...
def setup(app):
    ...
    app.add_config_value(
        'recommonmark_config', {
            'github_code_repo': 'https://github.com/mmicko/prjtang',
        }, True)
